                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6 col-sm-8">
                        <ul class="contact-info d-flex justify-content-end">
                            ...
                            <li>
                                <span><i class="fa fa-envelope"></i> RoyalOnlineBank@gmail.com</span>
                ...
                <div class="row">
                    <div class="col-lg-10 col-sm-9 d-none d-sm-block">
                        <ul class="mainmenu d-flex justify-content-end">
                            <li class="active"><a href="/RoyalOnlineBank/home"><spring:message code="label.home"/></a>
                           </li>
                            <li><a href="/RoyalOnlineBank/aboutUs"><spring:message code="label.aboutUs"/></a></li>
                            <li><a href="javascript:void(0);"><spring:message code="label.pages"/></a>
                                <ul>
                                    <li><a href="/RoyalOnlineBank/register"><spring:message code="label.RegistrationPage"/></a></li>
                                    <li><a href="service-details.html"><spring:message code="label.complaint"/></a></li>
                                     </ul>
                            </li>
                            ...
                            <li><a href="/RoyalOnlineBank/contact"><spring:message code="label.contact"/></a></li>
                        </ul>
                    </div>
                 <!-- --------login popup start -->                   
                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul class="metismenu">
                                ...
                                <li><a href="/RoyalOnlineBank/aboutUs">about us</a></li>
